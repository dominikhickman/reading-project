    ...
    <div className="container" style={{ paddingBottom: '60px' }}>
      ...
      <div style={{ display: 'flex', gap: '40px', flexWrap: 'wrap', alignItems: 'stretch' }}>
        ...
        <div className="glass-panel" style={{ 
          ...
          <h2 style={{ color: 'var(--primary-color)', fontSize: '2.5rem', marginBottom: '30px' }}>Your Buddy</h2>
          ...
          <div style={{ 
            ...
            {level > 1 && <div style={{ position: 'absolute', top: 30, right: 30, fontSize: '2.5rem' }}>✨</div>}
            {level > 2 && <div style={{ position: 'absolute', top: 40, left: 30, fontSize: '2.5rem' }}>🌟</div>}
          </div>
        ...
        >
          ...
          <div style={{ position: 'absolute', top: '10%', left: '5%', fontSize: '5rem', opacity: 0.25, transform: 'rotate(-20deg)' }}>🐝</div>
          <div style={{ position: 'absolute', bottom: '15%', right: '8%', fontSize: '6rem', opacity: 0.25, transform: 'rotate(15deg)' }}>🌸</div>
          <div style={{ position: 'absolute', top: '20%', right: '15%', fontSize: '4rem', opacity: 0.25, transform: 'rotate(45deg)' }}>✨</div>
          <div style={{ position: 'absolute', bottom: '20%', left: '15%', fontSize: '4rem', opacity: 0.2, transform: 'rotate(-45deg)' }}>🍃</div>
          
          <div style={{ fontSize: '10rem', marginBottom: '20px', filter: 'drop-shadow(0 15px 15px rgba(0,0,0,0.15))', zIndex: 1 }}>🐝</div>
          <h2 style={{ fontSize: '4rem', color: '#D81B60', margin: '0 0 20px 0', textShadow: '3px 3px 0px rgba(255,255,255,0.8)', zIndex: 1 }}>
          ...
          <div style={{ marginTop: '50px', zIndex: 1 }}>
            <span style={{ 
              background: 'white', color: '#D81B60', padding: '18px 50px', 
              borderRadius: 'var(--radius-pill)', fontSize: '2rem', fontWeight: '900',
